...
IDIOMA_ATTRS = {'en': {'indice': 'alertas_english_indice',
                       ...
                       'mensagem_inicial': "<p class='text-success'><i class='fas fa-info-circle'></i> There are STR_TOTAL Safety Alerts in our folder.</p><p class='text-secondary'>See below 5 random examples.</p>",
